    ...
    return (
         ...
         <div className="container mx-auto max-w-5xl">
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perferendis assumenda nam, ducimus
                eum reprehenderit ipsa laudantium et! At odit adipisci saepe iste nobis temporibus, perspiciatis veniam, magni deleniti ratione asperiores.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-8"> 
                    <h3 className="text-2xl font-semibold mb-6">Contact Information</h3>
                    <div className="space-y-6 text-left justify-center">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:trishaldesigns@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+91234567809" className="text-muted-foreground hover:text-primary transition-colors">
                                    +9 (123) 456 7809
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="pt-8 ">
                        ...
                        <div className="flex space-x-4 justify-center">
                            <a href="https://www.linkedin.com/in/trishal-basi-166652213" target="_blank">
                                <Linkedin />
                            </a>
                            <a href="https://www.instagram.com/bashi.gfx" target="_blank">
                                <Instagram />
                            </a>
                            <a href="https://www.facebook.com/beckham.bashi" target="_blank">
                                <Facebook />
                            </a>
                        </div>
                    </div>
